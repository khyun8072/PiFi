...
def training(args: argparse.Namespace) -> None:
    ...
    dataset_dict['train'] = SummarizationDataset(args, os.path.join(args.preprocess_path, args.task, args.task_dataset, args.model_type, 'train.pkl'), 'train')
    dataset_dict['valid'] = SummarizationDataset(args, os.path.join(args.preprocess_path, args.task, args.task_dataset, args.model_type, 'valid.pkl'), 'valid')
